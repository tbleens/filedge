...
@section('title', __('Add categories'))
            ...
            <div>
                <div class="border-bottom pb-4 mb-4 d-flex align-items-center
                  justify-content-between">
                    ...
                    <div>
                        <a href="{{ route('categories.list') }}" class="btn btn-primary">{{ __('Back') }}</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
            <div class="card h-100">
                ...
                <div class="card-header nav-line-bottom bg-white py-4">
                    <h4 class="mb-0">{{ __('Add categorie') }} </h4>
                </div>
                <form action="{{ route('categories.add') }}" method="POST" class="p-4">
                    @csrf
