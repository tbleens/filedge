    ...
    <div class="row my-6">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
            <div class="card h-100">
                ...
                <form action="{{ route('faqs.edit', $faq->id) }}" method="POST" class="p-4" enctype="multipart/form-data">
                    @csrf
                    ...
                    @endif
                    <input type="hidden" name="idUpdate" value="{{ $faq->id }}">
                    <!-- Input -->
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="visibility" name="visibility" class="form-select">
                            ...
                            <option value="1" @if($faq->visibility) selected @endif>{{ __('Public') }}</option>
                        </select>
                    </div>
