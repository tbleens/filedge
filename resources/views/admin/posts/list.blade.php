        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
            ...
            <div class="card h-100">
                ...
                <div class="card-header bg-white border-bottom-0 d-flex align-items-center justify-content-between">
                    <h4 class="mb-0">{{ __('List posts')}} </h4>
                    <a href="{{ route('posts.add') }}" class="btn btn-primary">{{ __('Add') }}</a>
                </div>
                <!-- table  -->
                <div class="table-responsive">
                    <table class="table text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="align-middle fw-bold">{{ $post->id }}</td>
                                <td class="align-middle"><img src="{{ asset('assets/posts/'.$post->image) }}" alt="{{ $post->name }}" width="60" height="40"></td>
                                <td class="align-middle">{{ getLimitContent($post->title, 50) }}</td>
