...
@section('title', __('Edit extension'))
                ...
                <div class="border-bottom pb-4 mb-4 d-flex align-items-center
                  justify-content-between">
                    <div class="mb-2 mb-lg-0">
                        <h3 class="mb-0 fw-bold">{{ __('Post') }}</h3>
                    </div>
                    <div>
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
            <div class="card h-100">
                ...
                <div class="card-header nav-line-bottom bg-white py-4">
                    <h4 class="mb-0">{{ __('Edit post')}} </h4>
                </div>
                <form action="{{ route('posts.edit', $post->id) }}" method="POST" class="p-4" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="p-3 mb-3 bg-light">
                        <img id="preview_image" src="{{ asset('assets/posts/'.$post->image) }}" width="250" height="150">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="short_description" class="form-control" id="short_description" rows="4">{{ $post->short_description }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="content" class="form-control" id="content" rows="4">{{ $post->content }}</textarea>
                        @error('content')
                        <div class="text-danger font-weight-normal mt-1 text-sm">
                            {{ $message }}
                        </div>
