    ...
    <div class="row my-6">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
            <div class="card h-100">
                ...
                <form action="{{ route('users.edit', $user->id) }}" method="POST" class="p-4">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="password" class="form-control" name="password" disabled>
                        @error('password')
                        <div class="text-danger font-weight-normal mt-1 text-sm">
                            {{ $message }}
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="role" name="role" class="form-select">
                            ...
                            <option value="1" @if($user->role) selected @endif>{{ __('Admin') }}</option>
                        </select>
                    </div>
